  ...
  <div class="col-md-9 mb-2">
    ...
    <div class="col-md-12 mb-3">
        ...
        <div class="card-header bg-purple">
                <div class="card-tittle text-black"><i class="fa fa-shopping-cart"></i> <b>Tambah Barang</b></div>
            </div>
            <div class="card-body">
                <form method="POST">
                    <div class="form-row">
   ...
   <div class="col-md-20 mb-2">
        <div class="card">
        <div class="card-header bg-purple">
                <div class="card-tittle text-black"><i class="fa fa-table"></i> <b>Data Barang</b></div>
            </div>
            <div class="card-body">
            <table class="data-table table-striped table-bordered table-sm dt-responsive nowrap" id="table" style="width: 750px; height: 200px;">
